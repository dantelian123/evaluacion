...
@Component({
  selector: 'app-content-invited',
  templateUrl: './content.component.html',
  styleUrls: ['./content.component.css']
})
export class ContentComponentInvited implements OnInit {
  authors?: Author;
  ...
  asignarTitulo(titulos: Titulo) {
    this.titleByAuthors = titulos;
    console.log(this.titleByAuthors);
  }
